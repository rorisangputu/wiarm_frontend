      ...
      <div className="w-[90%] mx-auto">
        <div className="flex flex-col">
          <div className="flex flex-col justify-start gap-3">
            ...
            <p className="text-gray-500 font-light md:max-w-lg md:text-lg">
          ...
          <hr className="my-10 flex w-[20%] md:w-[10%] border-t-2 border-gray-200" />
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-5 md:py-7">
            <div className="flex flex-col items-center gap-1 text-center">
              <PiFarmLight className="text-green-800 text-4xl" />
              <h1 className="font-normal text-green-800 text-md md:text-lg">
                Reclaiming Land
              </h1>
              <p className="text-md md:max-w-sm font-light text-slate-900">
            ...
            <div className="flex flex-col items-center gap-1 text-center">
              <GiCorn className="text-green-800 text-4xl" />
              <h1 className="font-normal text-green-800 text-md md:text-lg">
                Food Sovereignty
              </h1>
              <p className="text-md md:max-w-sm font-light text-slate-900">
            ...
            <div className="flex flex-col items-center gap-1 text-center">
              <GiBookshelf className="text-green-800 text-4xl" />
              <h1 className="font-normal text-green-800 text-md md:text-lg">
                Education & Advocacy
              </h1>
              <p className="text-md md:max-w-sm font-light text-slate-900">
